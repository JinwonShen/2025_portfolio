...
export default function Social() {
	return (
		<nav className={styles.socialContainer} aria-label="소셜 링크">
			<ul>
				<li>
					<Link
				...
				<li>
					<Link
						href={"https://velog.io/@bosv031999/posts"}
						target="_blank"
						rel="noopener noreferrer"
						aria-label="Velog 블로그 보기 (새 창)"
					>
						<svg
							className={styles.icon}
							role="img"
				...
				<li>
					<Link
						href={
							"https://sjinwon.notion.site/typescript-javascript-react-767ff7defe3b48e5882a83c5aa41a9cc?pvs=4"
						}
						target="_blank"
						rel="noopener noreferrer"
						aria-label="Notion 포트폴리오 보기 (새 창)"
					>
						<svg
							className={styles.icon}
							role="img"
